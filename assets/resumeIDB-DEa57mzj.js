const N='"Alibaba PuHuiTi", sans-serif',m=[{labelKey:"alibaba",label:"阿里巴巴普惠体",value:N,aliases:["Alibaba PuHuiTi, sans-serif",'"Alibaba PuHuiTi", sans-serif'],sources:[{family:"Alibaba PuHuiTi",url:"/fonts/AlibabaPuHuiTi-3-55-Regular.ttf",format:"truetype",weight:"400",style:"normal"},{family:"Alibaba PuHuiTi",url:"/fonts/AlibabaPuHuiTi-3-85-Bold.ttf",format:"truetype",weight:"700",style:"normal"}]},{labelKey:"misans",label:"小米 MiSans",value:'"MiSans", sans-serif',aliases:['"MiSans", "Microsoft YaHei", "微软雅黑", sans-serif','"Microsoft YaHei", "微软雅黑", sans-serif','"Microsoft YaHei Local", "Microsoft YaHei", "微软雅黑", sans-serif','"MiSans", sans-serif',"MiSans, sans-serif","Microsoft YaHei, sans-serif"],sources:[{family:"MiSans",url:"/fonts/MiSans-Normal.ttf",format:"truetype",weight:"400",style:"normal"},{family:"MiSans",url:"/fonts/MiSans-Medium.ttf",format:"truetype",weight:"700",style:"normal"}]},{labelKey:"notosanssc",label:"思源黑体",value:'"Noto Sans SC", "Noto Sans CJK SC", sans-serif',aliases:['"Noto Sans SC", "Noto Sans CJK SC", sans-serif',"Noto Sans SC, sans-serif"],sources:[{family:"Noto Sans SC",url:"/fonts/NotoSansSC-Regular.otf",format:"opentype",weight:"400",style:"normal"},{family:"Noto Sans SC",url:"/fonts/NotoSansSC-Medium.otf",format:"opentype",weight:"500",style:"normal"},{family:"Noto Sans SC",url:"/fonts/NotoSansSC-Bold.otf",format:"opentype",weight:"700",style:"normal"}]},{labelKey:"sourcehanserifsc",label:"思源宋体",value:'"Source Han Serif SC", "Noto Serif SC", serif',aliases:['"Source Han Serif SC", "Noto Serif SC", serif','"Noto Serif SC", "Source Han Serif SC", serif',"Source Han Serif SC, serif","Noto Serif SC, serif"],sources:[{family:"Source Han Serif SC",url:"/fonts/SourceHanSerifSC-Regular.otf",format:"opentype",weight:"400",style:"normal"},{family:"Source Han Serif SC",url:"/fonts/SourceHanSerifSC-Medium.otf",format:"opentype",weight:"500",style:"normal"},{family:"Source Han Serif SC",url:"/fonts/SourceHanSerifSC-Bold.otf",format:"opentype",weight:"700",style:"normal"}]}],y=new Map,b=e=>"/orange-resume/"+e.replace(/^\//,""),H=async e=>{const t=b(e);return y.has(e)||y.set(e,fetch(t).then(n=>n.ok?n.blob():(console.warn(`[fonts] 字体加载失败: ${e} (status=${n.status})`),null)).then(n=>new Promise((r,s)=>{if(n===null){r(null);return}const o=new FileReader;o.onloadend=()=>r(o.result),o.onerror=()=>s(new Error(`Failed to read font: ${e}`)),o.readAsDataURL(n)})).catch(n=>(console.warn(`[fonts] 字体转 base64 失败，将降级使用 URL: ${e}`,n),null))),y.get(e)},R=e=>{const t=e?.trim();return t&&m.find(n=>n.value===t||n.aliases.includes(t)||n.aliases.some(r=>t.includes(r.replace(/"/g,""))))||m[0]},w=(e,t)=>`@font-face {
  font-family: "${e.family}";
  src: url("${t}") format("${e.format}");
  font-weight: ${e.weight};
  font-style: ${e.style};
  font-display: swap;
}`,x=e=>R(e).value,L=e=>m.map(t=>({value:t.value,label:t.label})),_=async(e,t=!1)=>{const n=R(e);return(await Promise.all(n.sources.map(async s=>{if(t){const o=await H(s.url);return o?w(s,o):(console.warn(`[fonts] inline 失败，降级为 URL 引用: ${s.url}`),w(s,b(s.url)))}return w(s,b(s.url))}))).join(`
`)},A={baseFontSize:14,basePagePadding:20,baseLineHeight:1.5,baseModuleSpacing:10,paragraphSpacing:10,titleFontSize:16,subTitleFontSize:14,themeColor:"#111827",fontFamily:N,autoOnePage:!1},V={templateId:"classic",title:"未命名简历",createdAt:Date.now(),updatedAt:null,basic:{name:"陈下饭",position:"前端开发工程师",age:20,phone:"17311002299",address:"南京",email:"zhangsan@example.com",photo:"",photoConfig:{aspectRatio:"",width:90,height:120,visible:!0,borderRadius:5,customBorderRadius:0}},educations:[{id:"1",school:"清华大学",major:"软件工程",degree:"本科",dateRange:"2023-09-01 - 2027-06-30",visible:!0,gpa:"",description:`<ul>
  <li>
...
<ul>
  ...
  <li>
    <p>参与设计系统的基础布局组件与动态路由权限控制（路由守卫 + 角色权限），为后续权限扩展打下基础。</p>
      ...
      `}],customData:{},menuSections:[{id:"basic",title:"基本信息",order:"1"},{id:"education",title:"教育经历",order:"2"},{id:"internship",title:"实习经历",order:"3"},{id:"project",title:"项目经历",order:"4"},{id:"skills",title:"个人技能",order:"5"}],globalConfiguration:A},E="FileHandleDB",T=2,u="handles",d="config",S=()=>new Promise((e,t)=>{const n=indexedDB.open(E,T);n.onerror=()=>{t(new Error("打开数据库失败"))},n.onsuccess=()=>{e(n.result)},n.onupgradeneeded=r=>{const s=r.target.result;s.objectStoreNames.contains(u)||s.createObjectStore(u),s.objectStoreNames.contains(d)||s.createObjectStore(d)}}),z=async(e,t)=>{const n=await S();return new Promise((r,s)=>{const i=n.transaction(u,"readwrite").objectStore(u).put(t,e);i.onsuccess=()=>{r()},i.onerror=()=>{s(i.error)}})},F=async e=>{const t=await S();return new Promise((n,r)=>{const a=t.transaction(u,"readonly").objectStore(u).get(e);a.onsuccess=()=>{n(a.result)},a.onerror=()=>{r(a.error)}})},G=async(e,t)=>{const n=await S();return new Promise((r,s)=>{const i=n.transaction(d,"readwrite").objectStore(d).put(t,e);i.onsuccess=()=>{r()},i.onerror=()=>{s(i.error)}})},Y=async e=>{const t=await S();return new Promise((n,r)=>{const a=t.transaction(d,"readonly").objectStore(d).get(e);a.onsuccess=()=>{n(a.result)},a.onerror=()=>{r(a.error)}})},P=async(e,t="readwrite")=>{if(!e)return!1;const n={mode:t};return await e.queryPermission(n)==="granted"||await e.requestPermission(n)==="granted"},j=e=>{if(!e||typeof e!="object")return!1;const t=e;return typeof t.id=="string"&&t.id.length>0},g=e=>{if(!e)return null;const t=new Date(e).getTime();return Number.isFinite(t)?t:null},B=(e,t,n)=>{const r=g(e.updatedAt),s=g(t.updatedAt),o=typeof n=="number"&&Number.isFinite(n)?n:null;return r!==null&&s!==null?r!==s?r>s:o!==null&&o>s+1e3:r!==null&&s===null?!0:r===null&&s!==null?o!==null&&o>s+1e3:o!==null},D=(e,t)=>{if(typeof t!="number"||!Number.isFinite(t))return e;const n=g(e.updatedAt);return n!==null&&n>=t?e:{...e,updatedAt:new Date(t).toISOString()}},I=async(e,t)=>{const n=await v(e.id);if(!n){const s=D(e,t);return await $(s),!0}if(!B(e,n,t))return!1;const r=D(e,t);return await U(r.id,r),!0},M=async(e,t)=>{try{const n=await F("syncDirectory");if(!n||!await P(n))return;const s=n;if(t&&t.id===e.id&&t.title!==e.title)try{await s.removeEntry(`${t.title}.json`)}catch(c){console.warn("删除旧文件失败",c)}const o=`${e.title}.json`,i=await(await s.getFileHandle(o,{create:!0})).createWritable();await i.write(JSON.stringify(e,null,2)),await i.close()}catch(n){console.warn("同步简历到文件失败",n)}};let p=null;const O=(e,t)=>{p&&clearTimeout(p),p=setTimeout(()=>{M(e,t),p=null},1500)},J=async()=>{const e={skipped:0,synced:0,failed:0};if(typeof window>"u"||typeof indexedDB>"u")return e;try{const t=await F("syncDirectory");if(!t||t.kind!=="directory"||!await P(t))return e;const r=[];for await(const s of t.values())r.push(s);if(!r)return e;for await(const s of r){if(s.kind!=="file"||!s.name.endsWith(".json")){e.skipped++;continue}try{const o=await s.getFile(),a=await o.text(),i=JSON.parse(a);if(!j(i)){e.skipped++;continue}await I(i,o.lastModified)?e.synced++:e.skipped++}catch(o){e.failed++,console.error(`读取文件失败"${s.name}":`,o)}}}catch(t){console.error("同步简历失败",t)}return e},k="resumeDB",q=2,l="resumes",f=()=>new Promise((e,t)=>{const n=indexedDB.open(k,q);n.onerror=()=>{t(new Error("打开数据库失败"))},n.onsuccess=()=>{e(n.result)},n.onupgradeneeded=r=>{const s=r.target.result;if(!s.objectStoreNames.contains(l)){const o=s.createObjectStore(l,{keyPath:"id"});o.createIndex("createdAt","createdAt",{unique:!1}),o.createIndex("updatedAt","updatedAt",{unique:!1})}}}),$=async e=>{const t=await f();return new Promise((n,r)=>{const o=t.transaction(l,"readwrite").objectStore(l),a={...e,createdAt:Date.now(),updatedAt:null},i=o.add(a);i.onsuccess=()=>{n(a.id)},i.onerror=()=>{r(new Error("添加简历失败"))}})},K=async()=>{const e=await f();return new Promise((t,n)=>{const o=e.transaction(l,"readonly").objectStore(l).getAll();o.onsuccess=()=>{t(o.result)},o.onerror=()=>{n(new Error("获取简历列表失败"))}})},v=async e=>{const t=await f();return new Promise((n,r)=>{const a=t.transaction(l,"readonly").objectStore(l).get(e);a.onsuccess=()=>{n(a.result||null)},a.onerror=()=>{r(new Error("获取简历失败"))}})},U=async(e,t)=>{const n=await f();return new Promise((r,s)=>{const a=n.transaction(l,"readwrite").objectStore(l),i=a.get(e);i.onsuccess=()=>{const c=i.result;if(!c){r(!1);return}const h={...c,...t,updatedAt:Date.now()};O(h,c);const C=a.put(h);C.onsuccess=()=>{r(!0)},C.onerror=()=>{s(new Error("更新简历失败"))}},i.onerror=()=>{s(new Error("获取简历失败"))}})},W=async e=>{const t=await f();return new Promise((n,r)=>{const a=t.transaction(l,"readwrite").objectStore(l).delete(e);a.onsuccess=()=>{n(!0)},a.onerror=()=>{r(new Error("删除简历失败"))}})};export{V as D,m as F,Y as a,K as b,$ as c,W as d,G as e,J as f,F as g,_ as h,L as i,v as j,A as k,x as n,z as s,U as u,P as v};
